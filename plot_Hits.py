...
##                                                                                                             ##
##                                         run with python3                                                    ##
##  Replace the file to open with the disired text file in your current directory, that has the rootfiles path ##
##  Depending  on the run#, replace the TTree string in Tree = file[ ]; string options provided                ##
##  For Dict_list for-loop, change the first replace() string with the parameter of the run                    ##
##                                                                                                             ##
#################################################################################################################
...
for P,C in zip(DictList_toPlot,BinningList_toPlot):
	...
	for k,v in P.items(): # loop the values dictionary
		...
		## and make any zero or infinity values NAN	
